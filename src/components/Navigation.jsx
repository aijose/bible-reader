        ...
        <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          ...
          <div className="flex items-center space-x-4 flex-1 lg:flex-none">
            ...
            <select
              ...
              className="flex-1 lg:flex-none border-2 border-gray-200 bg-white/90 backdrop-blur-sm rounded-xl text-gray-900 font-semibold shadow-lg focus:ring-2 focus:ring-blue-500 focus:bg-white focus:border-blue-300 transition-all duration-200 appearance-none cursor-pointer hover:border-gray-300"
              style={{
