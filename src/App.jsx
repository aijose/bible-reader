          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-700 mt-1" style={{ fontWeight: 700, fontSize: '1.25rem' }}>
                  Discover Scripture with AI-powered commentary and semantic search
                </p>
                <p className="text-gray-500 mt-1 flex items-center gap-1.5" style={{ fontSize: '1rem' }}>
                  <svg className="flex-shrink-0" fill="#EAB308" viewBox="0 0 20 20" style={{ width: '2em', height: '2em' }}>
